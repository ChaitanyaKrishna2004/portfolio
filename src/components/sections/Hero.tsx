          ...
          <motion.div
            ...
            {[
              ...
              <motion.div
                ...
                <div
                  className={`relative flex items-center justify-center w-10 h-10 sm:w-12 sm:h-12 rounded-full border border-black/10 dark:border-white/20 bg-background/80 backdrop-blur-md transition-all duration-300 hover:scale-110 hover:${tech.shadow} hover:shadow-lg cursor-pointer`}>
                  <tech.Icon
                    className={`w-5 h-5 sm:w-6 sm:h-6 ${tech.color} transition-opacity`}
                  />
          ...
          <div className="flex w-full flex-col items-start text-left lg:order-first shrink">
            ...
            <motion.div
              ...
              <p className="text-sm sm:text-base lg:text-lg font-medium">
                building applications that are fast, secure, and incredibly easy
                to use. I love turning complex problems into simple, elegant
                solutions.
              </p>
            </motion.div>
            ...
            <motion.div
              ...
              <a
                href="/Paruchuri_Chaitanya_Krishna_Resume.pdf"
                target="_blank"
            ...
            <motion.div
              ...
              <a
                href="https://github.com/ChaitanyaKrishna2004/"
                target="_blank"
                rel="noopener noreferrer"
              ...
              <a
                href="https://www.linkedin.com/in/paruchuri-chaitanya-krishna-768557255/?skipRedirect=true"
                target="_blank"
                rel="noopener noreferrer"
                className="group relative">
              ...
              <a
                href="https://leetcode.com/u/chaitanya2004/"
                target="_blank"
                rel="noopener noreferrer"
                className="group relative">
              ...
              <a
                href="https://takeuforward.org/profile/krishnaparuchuri2004"
                target="_blank"
                rel="noopener noreferrer"
                className="group relative">
        ...
        <motion.div
          ...
          {stats.map((stat, idx) => (
            <div
              ...
              <div
                className={`w-12 h-12 sm:w-14 sm:h-14 shrink-0 rounded-full flex items-center justify-center ${stat.iconBg}`}>
                {stat.icon}
              </div>
